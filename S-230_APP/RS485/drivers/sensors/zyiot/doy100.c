...
static char _pn_match_name[MAX_MATCH_TYPE_COUNT][RS485_SENSOR_MAX_PN_LEN] = {"DO-Y10", "DO-Y10"};
const static char _manufacturer_match[MAX_MATCH_TYPE_COUNT] = {RS485_DRIVER_DO_MANUFACTURER_ZYIOT, RS485_DRIVER_DO_MANUFACTURER_ZYIOT};
const static char _model_match[MAX_MATCH_TYPE_COUNT] = {RS485_SENSOR_MODEL_ID_DOY100, RS485_SENSOR_MODEL_ID_DOY100};
const static char _theory_match[MAX_MATCH_TYPE_COUNT] = {SENSOR_THEORY_MEMBRANE, SENSOR_THEORY_OPTICS};
// static char _theory_match[MAX_MATCH_TYPE_COUNT] = {SENSOR_THEORY_OPTICS, SENSOR_THEORY_OPTICS};
const static char _pn_name[MAX_MATCH_TYPE_COUNT][RS485_SENSOR_MAX_PN_LEN] = {"DO-Y100", "DO-Y102"};
// *** end

#define SENSOR_ID   (RS485_DRIVER_SENSOR_ID_DO)
static rs485_sensor_driver_t sensor_driver;
const static char _PN_default[RS485_SENSOR_MAX_PN_LEN] = {"DO-Y100"};
...
static int _read_compensation(rs485_sensor_s_t *rs485, uint8_t indicatorID, float *value)
{
    ...
    uint8_t buffer[2] = {0};
    int rc = RS485_read_register(rs485->port, rs485->id, DOY100_COMPENSATION_REG, 1, buffer, RS485_DRIVER_copy_buffer, NULL, NULL);
...
static int _write_compensation(rs485_sensor_s_t *rs485, uint8_t indicatorID, float value)
{
    ...
    return RS485_write_register(rs485->port, rs485->id, DOY100_COMPENSATION_REG, f, NULL, NULL, NULL, NULL);
}
...
static int _write_calibrate(rs485_sensor_pt rs485, uint8_t type, void *params)
{
    ...
    return RS485_write_register(rs485->port, rs485->id, DOY100_CALIBRATE_REG, 0x02, NULL, NULL, NULL, NULL);
}
...
static int _read_value1(rs485_sensor_pt rs485, rs485_sensor_indicator_pt indicator)
{
    int rc = RS485_read_register(rs485->port, rs485->id, DOY100_VALUE_REG, 5, indicator, _parse_value, _parse_value_error, NULL);
    if (rc != RS485_OK)
    {
        indicator->status = rc;
        return rc;
...
int RS485_DRIVER_zyiot_doy100_init(void)
{
    ...
    static rs485_sensor_driver_t sd_17 = {.manufacturer = RS485_DRIVER_DO_MANUFACTURER_ZYIOT, .model = RS485_SENSOR_MODEL_ID_DOY100, .protocol = 0, .id = 17, .action = &_action};
