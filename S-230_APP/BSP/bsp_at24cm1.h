...
#include "gpio_at24cxx.h"
    ...
    extern GPIO_AT24CXX_TypeDef gpio_at24cm1;
#define BSP_AT24CM1_DEVICE_ID1  0
#define BSP_AT24CM1_DEVICE_ID2  1
#define BSP_AT24CM1_DEVICE_ID   (BSP_AT24CM1_DEVICE_ID2)
